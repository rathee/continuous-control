...
We are using 20 agents to solve the task and these work as follows:
...
### Training
Run train.py file to train the agent
```
python train.py
```

### Implementation details
1. The algorithm being used is from [this paper](https://arxiv.org/pdf/1509.02971.pdf), _Continuous Control with
Deep Reinforcement Learning_, by researchers at Google Deepmind.
...
4. Replay buffer is being used used to train the network.
...
### Output
1. Agent took 111 episode to reach an average reward of 30 over 100 consecutive episodes.
2. Weights are being saved at actor_ckpt.pth and critic_ckpt.pth
3. The graph below shows the final results:
<img src="output.png" width="70%" align="top-left" alt="" title="Results Graph" />
